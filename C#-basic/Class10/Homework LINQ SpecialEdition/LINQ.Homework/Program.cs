...
namespace LINQ.Homework
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // - print the mass of the earth on July 1895 XD => x/y*mc2 = 158995,2kg;
            /*  
                ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
                ░░░░░░░░░░░░░░░░░░░░░░████████░░░░░░░░░
                ░░███████░░░░░░░░░░███▒▒▒▒▒▒▒▒███░░░░░░
            ...
            */
            ...
            foreach(var item in songsGroupedByAlbumId)
            {
                albumsByIdWithAverageDuration.Add(item.Key, item.Select(x => x.Duration).Average());
            }
            // now i have albums grouped by id and the average duration. 
            // How to get the key (album id) of the highest Average Duration.            
            var orderedDictionary = albumsByIdWithAverageDuration.OrderBy(x => x.Value);//sorted by values ascending.
            //now to get the last key as an int (because of the order the last one has highestDuration)
            Console.WriteLine(orderedDictionary.Count());

            //double albumIDwithHighestAverageDuration = orderedDictionary.LastOrDefault(x => x.Value);
