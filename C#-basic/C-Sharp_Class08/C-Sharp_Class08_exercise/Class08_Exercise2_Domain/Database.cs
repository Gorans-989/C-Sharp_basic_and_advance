...
namespace Class08_Exercise2_Domain
{
    ...
    {
        public static List<Person> FansArray { get; set; }
        ...
        private static List<Person> getFans()
        {
            List<Person> arrayOfFans = new List<Person>
            {
        ...
        {
            List<Song> arrayOfSongs = new List<Song>
            {
            new Song("Bohemian Rhapsody", 367, Genre.Rock),
            new Song("Candy Shop", 156, Genre.Hip_Hop),
